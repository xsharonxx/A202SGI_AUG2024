...
public class SSellerAdapter extends RecyclerView.Adapter<SSellerAdapter.ViewHolder>{
    private List<SSeller> sellerList;
    private Fragment fragment;

    public SSellerAdapter(List<SSeller> sellerList, Fragment fragment){
    ...
    @NonNull
    @Override
    public SSellerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SSellerAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.s_seller, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull SSellerAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent(fragment.getActivity(), SViewDetail.class);
