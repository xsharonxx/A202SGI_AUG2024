...
public class BHDetailAdapter extends RecyclerView.Adapter<BHDetailAdapter.ViewHolder>{
    private ArrayList<CBProduct> selectedProducts;
    private Context context;

    public BHDetailAdapter(ArrayList<CBProduct> selectedProducts, Context context){
    ...
    @NonNull
    @Override
    public BHDetailAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BHDetailAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.bh_detail_card, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull BHDetailAdapter.ViewHolder holder, int position) {
