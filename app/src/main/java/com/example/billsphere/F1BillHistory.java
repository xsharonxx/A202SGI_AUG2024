...
public class F1BillHistory extends Fragment {

    private SearchView searchBar;
    private ImageButton filterButton;
    private RecyclerView recyclerView;

    private BHReceiptAdapter receiptAdapter;

    private List<BHReceipt> receiptList, filteredList;
    ...
    private void updateReceiptRecyclerView(){
        ...
        if (selectedFilter[0] == 0){
            query = receiptRef.whereEqualTo("customerId", user)
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                BHReceipt temp = new BHReceipt(businessId, paymentMethod, totalAmount, localDateTime,
                                        selectedProducts, receiptId);
                                Task<DocumentSnapshot> userTask = db.collection("user").document(businessId).get();
    ...
    private void searchReceipt(String s){
        ...
        if (s.isEmpty()) {
            ...
            for (BHReceipt receipt : receiptList) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment1_bill_history, container, false);
        ...
        receiptAdapter = new BHReceiptAdapter(filteredList, this);
